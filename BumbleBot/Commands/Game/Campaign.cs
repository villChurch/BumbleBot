        ...
        public static async Task DoCampaign(CommandContext ctx, int goatId, int bet)
        {
            ...
            switch (scenarioNumber)
            {
                ...
                case 2:
                    expToAdd = rnd.Next(600, 1000) + 1;
                    _goatService.GiveGoatExp(goat, expToAdd);
                    campaignMessage = $"{goat?.Name} won Best of Breed, congratulations! She earned {expToAdd} XP";
                    break;
                case 3:
                ...
                case 9:
                    ...
                    _goatService.GiveGoatExp(goat, expToAdd);
                    campaignMessage =
                        $"{goat?.Name} strutted her stuff at the show and was Grand Champion, after being praised by the judge." +
                        $" She earned {expToAdd} XP and a prize of 1000 credits.";
                    break;
                case 10:
                    _farmerService.AddCreditsToFarmer(ctx.User.Id, 500);
                ...
                case 11:
                    ...
                    _goatService.GiveGoatExp(goat, expToAdd);
                    campaignMessage =
                        $"{goat?.Name} was full of confidence and easily took the Best of Breed ribbon. She earned {expToAdd} XP";
                    break;
                case 12:
                    expToAdd = rnd.Next(250, 600) + 1;
                    _goatService.GiveGoatExp(goat, expToAdd);
                ...
                case 17:
                    ...
                    campaignMessage =
                        ...
                        $"She did not place and lost {expToAdd} XP due to fright.";
                    break;
                case 18:
                ...
                case 20:
                    ...
                    campaignMessage =
                        ...
                        $"She earned {expToAdd} XP and a prize of 500 credits.";
                    break;
                case 21:
                    expToAdd = rnd.Next(600, 1000) + 1;
                    _goatService.GiveGoatExp(goat, expToAdd);
                    campaignMessage =
                        "{goat?.Name} stopped to pee multiple times during her show, but the judge was indulgent. She earned {expToAdd} XP";
                    break;
                case 22:
                    expToAdd = rnd.Next(250, 600) + 1;
                    _goatService.GiveGoatExp(goat, expToAdd);
                ...
                case 27:
                    ...
                    _goatService.GiveGoatExp(goat, expToAdd * -1);
                    campaignMessage =
                        $"{goat?.Name} was ready for the show, but you trimmed her hooves too short and she developed a limp." +
                        $" She lost {expToAdd} XP from the temporary soreness.";
                    break;
                case 28:
                    expToAdd = rnd.Next(150, 250) + 1;
                    _farmerService.DeductCreditsFromFarmer(ctx.User.Id, 100);
                    _goatService.GiveGoatExp(goat, expToAdd * -1);
                    campaignMessage = $"{goat?.Name} escaped her holding pen and caused havoc in the parking lot." +
                ...
                case 31:
                    ...
                    _goatService.GiveGoatExp(goat, expToAdd);
                    campaignMessage =
                        $"{goat?.Name} put her trust in you and followed your lead, straight to Champion status. She earned {expToAdd} XP";
                    break;
                case 32:
                    expToAdd = rnd.Next(250, 600) + 1;
                    _goatService.GiveGoatExp(goat, expToAdd);
                ...
                case 33:
                    ...
                    _goatService.GiveGoatExp(goat, expToAdd);
                    campaignMessage =
                        $"{goat?.Name} did not do as well in the looks department, but she outshone the other does with her beautiful udder. " +
                        $"She earned {expToAdd} XP.";
                    break;
                case 34:
                    expToAdd = rnd.Next(250, 600) + 1;
                    _goatService.GiveGoatExp(goat, expToAdd);
                ...
                case 37:
                    ...
                    campaignMessage =
                        ...
                        $"She lost {expToAdd} XP - and her voice.";
                    break;
                case 38:
                    expToAdd = rnd.Next(150, 250) + 1;
                    _farmerService.DeductCreditsFromFarmer(ctx.User.Id, 100);
            ...
            {
                campaignMessage =
                    $"Oh no! {goat?.Name} has lost all of her XP through the stress of showing. " +
                    $"She became ill, and passed away shortly after returning home. Rest in peace {goat?.Name}.";
            }
            else
            {
